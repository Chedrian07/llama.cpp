...
// TurboQuant extern declarations: symmetric combinations
#define EXTERN_DECL_FATTN_VEC_TURBO_SYM(D, type_KV) \
    extern DECL_FATTN_VEC_CASE(D, type_KV, type_KV);

#define EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(type_KV) \
    EXTERN_DECL_FATTN_VEC_TURBO_SYM( 64, type_KV) \
    EXTERN_DECL_FATTN_VEC_TURBO_SYM(128, type_KV) \
    EXTERN_DECL_FATTN_VEC_TURBO_SYM(256, type_KV)

EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBO2_0)
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBO2H_0)
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBO3_0)
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBO3H_0)
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBO4_0)
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBOP3_0)
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBOP4_0)
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_SYM(GGML_TYPE_TURBOP5_0)

// TurboQuant extern declarations: asymmetric combinations
#define EXTERN_DECL_FATTN_VEC_TURBO_ASYM(D, type_K, type_V) \
    extern DECL_FATTN_VEC_CASE(D, type_K, type_V);

#define EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_ASYM(type_K, type_V) \
    EXTERN_DECL_FATTN_VEC_TURBO_ASYM( 64, type_K, type_V) \
    EXTERN_DECL_FATTN_VEC_TURBO_ASYM(128, type_K, type_V) \
    EXTERN_DECL_FATTN_VEC_TURBO_ASYM(256, type_K, type_V)

EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_ASYM(GGML_TYPE_TURBO4_0, GGML_TYPE_TURBO2_0)   // K4/V2
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_ASYM(GGML_TYPE_TURBO4_0, GGML_TYPE_TURBO3_0)   // K4/V3
EXTERN_DECL_FATTN_VEC_TURBO_ALL_D_ASYM(GGML_TYPE_TURBO3_0, GGML_TYPE_TURBO2_0)   // K3/V2
