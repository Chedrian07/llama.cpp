...
GGML_API void quantize_row_turbo2h_0_ref(const float * GGML_RESTRICT x, block_turbo2h_0 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_turbo3_0_ref (const float * GGML_RESTRICT x, block_turbo3_0  * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_turbo3h_0_ref(const float * GGML_RESTRICT x, block_turbo3h_0 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_turbo4_0_ref (const float * GGML_RESTRICT x, block_turbo4_0  * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_turbop3_0_ref(const float * GGML_RESTRICT x, block_turbop3_0 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_turbop4_0_ref(const float * GGML_RESTRICT x, block_turbop4_0 * GGML_RESTRICT y, int64_t k);
GGML_API void quantize_row_turbop5_0_ref(const float * GGML_RESTRICT x, block_turbop5_0 * GGML_RESTRICT y, int64_t k);
...
GGML_API void dequantize_row_turbo2h_0(const block_turbo2h_0 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_turbo3_0 (const block_turbo3_0  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_turbo3h_0(const block_turbo3h_0 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_turbo4_0 (const block_turbo4_0  * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_turbop3_0(const block_turbop3_0 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_turbop4_0(const block_turbop4_0 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
GGML_API void dequantize_row_turbop5_0(const block_turbop5_0 * GGML_RESTRICT x, float * GGML_RESTRICT y, int64_t k);
...
GGML_API size_t quantize_turbo2h_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
...
GGML_API size_t quantize_turbo3h_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
...
GGML_API size_t quantize_turbop3_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_turbop4_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
GGML_API size_t quantize_turbop5_0(const float * GGML_RESTRICT src, void * GGML_RESTRICT dst, int64_t nrows, int64_t n_per_row, const float * imatrix);
