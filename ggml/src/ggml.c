...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO2H_0] = {
        .type_name                = "turbo2h",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbo2h_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo2h_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo2h_0_ref,
    },
    [GGML_TYPE_TURBO3_0] = {
        .type_name                = "turbo3",
        .blck_size                = QK_TURBO,
    ...
    [GGML_TYPE_TURBO3H_0] = {
        .type_name                = "turbo3h",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbo3h_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbo3h_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbo3h_0_ref,
    },
    [GGML_TYPE_TURBO4_0] = {
        .type_name                = "turbo4",
        .blck_size                = QK_TURBO,
    ...
    [GGML_TYPE_TURBOP3_0] = {
        .type_name                = "turbop3",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbop3_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbop3_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbop3_0_ref,
    },
    [GGML_TYPE_TURBOP4_0] = {
        .type_name                = "turbop4",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbop4_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbop4_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbop4_0_ref,
    },
    [GGML_TYPE_TURBOP5_0] = {
        .type_name                = "turbop5",
        .blck_size                = QK_TURBO,
        .type_size                = sizeof(block_turbop5_0),
        .is_quantized             = true,
        .to_float                 = (ggml_to_float_t) dequantize_row_turbop5_0,
        .from_float_ref           = (ggml_from_float_t) quantize_row_turbop5_0_ref,
    },
    [GGML_TYPE_Q4_0] = {
        .type_name                = "q4_0",
        .blck_size                = QK4_0,
