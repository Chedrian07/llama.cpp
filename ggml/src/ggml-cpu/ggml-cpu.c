...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO2_0] = {
        ...
        .vec_dot                  = ggml_vec_dot_turbo2_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO2H_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbo2h_0_ref,
        .vec_dot                  = ggml_vec_dot_turbo2h_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO3_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbo3_0_ref,
        .vec_dot                  = ggml_vec_dot_turbo3_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO3H_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbo3h_0_ref,
        .vec_dot                  = ggml_vec_dot_turbo3h_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO4_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbo4_0_ref,
        .vec_dot                  = ggml_vec_dot_turbo4_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBOP3_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbop3_0_ref,
        .vec_dot                  = ggml_vec_dot_turbop3_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBOP4_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbop4_0_ref,
        .vec_dot                  = ggml_vec_dot_turbop4_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBOP5_0] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbop5_0_ref,
        .vec_dot                  = ggml_vec_dot_turbop5_0_q8_K,
        .vec_dot_type             = GGML_TYPE_Q8_K,
        .nrows                    = 1,
    },
    [GGML_TYPE_I32] = {
